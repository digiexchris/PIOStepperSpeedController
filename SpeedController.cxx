...
// Stepper::Stepper(uint32_t stepPin, uint32_t startSpeedHz, uint32_t
// maxSpeedHz,
...
//   // So, if we have a divisor of 2, and a sysclk of 125,000,000, and a period
//   of
...
//   // Convert acceleration from steps/s² to cycles per REAL LIFE integer
//   period
...
//       static_cast<uint32_t>((mySysClk / myConfiguredPrescaler) /
//       acceleration);
...
//   // SM configuration
//   pio_sm_config c =
//   StepperSpeedController_program_get_default_config(myOffset);
...
//   float newPeriod = static_cast<float>(mySysClk) / (myConfiguredPrescaler) /
//   hz;
